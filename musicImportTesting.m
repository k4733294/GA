...
chordImportInfo(rhythmNum).track = 4;
chordImportInfo(rhythmNum).howManyMeasureWeWant = 8;
...
version = 'hardwell_Output';
Melodyexport(chordImportInfo(2),version);
%}
%{
chordImportInfo(rhythmNum).Objfun='chordMelody';
chordImportInfo(rhythmNum).midiString = '/Users/hooshuu/Music/midi/david_guetta-lovers_on_the_sun_feat_sam_martin.midi';
chordImportInfo(rhythmNum).mainOrChord=1; % 0 = main melody 1=import chord melody
chordImportInfo(rhythmNum).track=5;
chordImportInfo(rhythmNum).howManyMeasureWeWant=5;
...
%{
chordImportInfo(rhythmNum).Objfun='chordMelody';
chordImportInfo(rhythmNum).midiString = '/Users/hooshuu/Music/midi/calvin_harris-summer_logicformat.mid';
chordImportInfo(rhythmNum).mainOrChord=1; % 0 = main melody 1=import chord melody
